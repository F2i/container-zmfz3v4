...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zmfz3v4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zmfz3v4.containers.anotherwebservice.com/
...
```
git clone git@github.com:F2i/container-zmfz3v4.git
cd container-zmfz3v4
```
...
```
docker attach container-zmfz3v4
```
